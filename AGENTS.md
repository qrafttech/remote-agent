# Reference: every step, message and refusal

This file is the exact account of what the code does — each step of a run, every message it prints, every state it reads, and why the boundaries sit where they do. `README.md` is the runbook; when a behaviour changes, this file changes with it.
